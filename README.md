...
python -m ptz_pano.tools.build_panorama --scan data/scans/scan_001 --lens-calibration config/lens_calibration.local.json --projection sphere --strategy max_weight --stitch-quality quality
```
